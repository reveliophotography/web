      ...
      <section className="grid md:grid-cols-5 gap-12 items-center">
        ...
        <div className="md:col-span-3">
          <h1 className="text-5xl font-serif font-bold text-primary mb-6">
            Nuestra Misión es Contar Vuestra Historia
          </h1>
          <div className="space-y-6 text-lg text-foreground/80 leading-relaxed">
            <p>
              ¡Hola! Somos Revelio, un equipo de fotógrafos de bodas afincados en Andalucía, aunque viajamos a donde vuestras historias nos lleven. Nuestras cámaras no son solo herramientas, son nuestra forma de conectar con las personas y de capturar la belleza efímera de los momentos que de verdad importan.
            </p>
            <p>
              Empezamos en la fotografía por nuestro amor a las historias. Cada pareja tiene una narrativa única, una energía especial, y nuestro mayor privilegio es ser los encargados de traducirla a imágenes. No buscamos poses forzadas ni sonrisas artificiales. Buscamos la verdad: la emoción en una mirada, la complicidad en un gesto, la alegría desbordante de una celebración.
            </p>
            <p>
              Creemos en un enfoque cercano y relajado. El día de vuestra boda, seremos una presencia discreta, amigos con cámaras, permitiendo que os sintáis cómodos y seáis vosotros mismos. Porque es ahí, en la autenticidad, donde reside la verdadera magia.
            </p>
          </div>
        </div>
      </section>
