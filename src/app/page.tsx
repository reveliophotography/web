...
const heroSlides = [
  { src: '/carrusel2.jpg', alt: 'Preboda foto general de Alejandro & Marta en lago', dataAiHint: 'foto boda' },
  { src: '/_DMA1946.jpg', alt: 'Boda foto general  ceremonia de Helena & Dani en lago', dataAiHint: 'foto boda' },
  { src: '/carrusel12.jpg', alt: 'Boda foto media  ceremonia de Helena & Dani en lago', dataAiHint: 'foto boda' },
];
